...
namespace MyData.Helpter
{
    ...
    class LogHelpterAnDa
    {
        ...
        {
            string fileName = fileFolderPath + "\\" + "data_log_cur.txt";
            string fileNameBackup = fileFolderPath + "\\" + "data_log_bak.txt";
        ...
        public static void GetLogUpload()
        {
            ...
            try
            {
                ...
                string fileName = fileFolderPath + "\\" + "data_log_cur.txt";
                string fileNameBackup = fileFolderPath + "\\" + "data_log_bak.txt";
                string fileNameUpload = fileFolderPath + "\\" + "data_log_upload.txt";
        ...
        public static void AddLog(string msg)
        {
            ...
            try
            {
                ...
                if (files.Length == 0)
                {
                    fileName = fileFolderPath + "\\" + "data_log_cur.txt";
                    goto DO_WRITE;
                }
                string[] files2 = files.OrderByDescending(x => x).ToArray();
                FileInfo fileInfo = new FileInfo(files2[0]);
