...
namespace KpMyModbus.Modbus.Protocol
{
    public static class ModbusUtils
    {
        ...
        /// </summary>
        public static string GetTableTypeName(ModbusRegisterType tableType)
        {
            switch (tableType)
            {
        ...
        /// </summary>
        public static int GetQuantity(TagDataType elemType)
        {
            switch (elemType)
            {
        ...
        /// </summary>
        public static int GetDataLength(TagDataType elemType)
        {
            return elemType == TagDataType.Bool ? 1 : GetQuantity(elemType) * 2;
        }
