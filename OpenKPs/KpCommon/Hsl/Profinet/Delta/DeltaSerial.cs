...
namespace HslCommunication.Profinet.Delta
{
	...
	/// </example>
	public class DeltaSerial : ModbusRtu, IDelta
	{
		#region Constructor
		...
		/// </summary>
		public DeltaSerial( ) : base( ) { ByteTransform.DataFormat = DataFormat.CDAB; }
		...
		public DeltaSerial( byte station = 0x01 ) : base( station ) { ByteTransform.DataFormat = DataFormat.CDAB; }
		...
		/// <inheritdoc/>
		public override string ToString( ) => $"DeltaSerial[{PortName}:{BaudRate}]";
