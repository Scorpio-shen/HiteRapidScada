...
{
	/// <summary>
	/// <b>[商业授权]</b> 富士Command-Setting-type协议实现的虚拟服务器，支持的地址为 B,M,K,D,W9,BD,F,A,WL,W21,W9。具体的支持列表参考api文档<br />
	/// <b>[Authorization]</b> The virtual server implemented by Fuji Command-Setting-type protocol supports addresses B, M, K, D, W9, BD, F, A, WL, W21, W9. 
	/// For the specific support list, please refer to the api documentation
	/// </summary>
	/// <remarks>
	/// 当前的虚拟服务器仅支持企业用户调用，实例化之后，调用<see cref="NetworkServerBase.ServerStart()"/> 方法即可，还有个参数<see cref="DataSwap"/>需要特别注意，约定了数据的大小端形式。
	/// </remarks>
	/// <example>
	/// <inheritdoc cref="FujiCommandSettingType" path="example"/>
	/// </example>
