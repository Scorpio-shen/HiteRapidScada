...
namespace HslCommunication.Profinet.Melsec
{
	...
	public class MelsecFxSerial : SerialDeviceBase
	{
		...
		public override OperateResult<byte[]> Read( string address, ushort length ) => MelsecFxSerialOverTcp.ReadHelper( address, length, ReadFromCoreServer, IsNewVersion );

		/// <inheritdoc cref="MelsecFxSerialOverTcp.Write(string, byte[])"/>
		[HslMqttApi( "WriteByteArray", "" )]
		public override OperateResult Write( string address, byte[] value ) => MelsecFxSerialOverTcp.WriteHelper( address, value, ReadFromCoreServer, IsNewVersion );
		...
		public override OperateResult<bool[]> ReadBool( string address, ushort length ) => MelsecFxSerialOverTcp.ReadBoolHelper( address, length, ReadFromCoreServer );

		/// <inheritdoc cref="MelsecFxSerialOverTcp.Write(string, bool)"/>
		[HslMqttApi( "WriteBool", "" )]
		public override OperateResult Write( string address, bool value ) => MelsecFxSerialOverTcp.WriteHelper( address, value, ReadFromCoreServer );
