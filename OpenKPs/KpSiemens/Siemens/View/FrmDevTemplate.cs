...
namespace KpSiemens.Siemens.View
{
    public partial class FrmDevTemplate : Form
    {
        ...
        SiemensTagGroup tagGroup;                           //选中测点组的数据
        ...
        private void FrmDevTemplate_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ctrlPLCConfig.ConnectionOptions = deviceTemplate.CreateOptions();
                FillTree();
            }
        }
        ...
        private void btnMoveUp_Click(object sender, EventArgs e)
        {
            ...
            if(tagGroup != null)
            {
                var prevTagGroup = prevNode.Tag as SiemensTagGroup;
        ...
        private void treeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            tagGroup = tag as SiemensTagGroup;
        ...
        private void ctrlRead_TagGroupChanged(object sender, TagGroupChangedEventArgs e)
        {
            Modified = true;
            if(tagGroup != null)
            {
        ...
        private void ctrlPLCConfig_PLCConfigChanged(object sender, PLCConfigChangedEventArgs e)
        {
            Modified = true;
        }
        #endregion
        ...
        private void ShowTagGroupProps(SiemensTagGroup tagGroup)
        {
            ctrlRead.Visible = true;
            ctrlRead.SiemensTagGroup = tagGroup;
        }
        ...
        private void FillTree()
        {
            ...
            foreach (SiemensTagGroup siemensTagGroup in deviceTemplate.TagGroups)
                tagGroupRootNode.Nodes.Add(NewTagGroupNode(siemensTagGroup));

            tagGroupRootNode.Expand();
            treeView.EndUpdate();
        }

        private TreeNode NewTagGroupNode(SiemensTagGroup tagGroup)
        {
            //tagGroup.Name = "点组";
        ...
        private string GetTagGroupDesc(SiemensTagGroup tagGroup)
        {
