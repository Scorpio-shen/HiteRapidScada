...
namespace Scada.Comm.Devices
{
    ...
    public class KpModbusLogic : KPLogic
    {
        ...
        private ModbusPoll modbusPoll;              // kp进程质疑的对象
        private ModbusPoll.RequestDelegate request; // 查询执行方法
        private byte devAddr;                       // 设备地址
        private List<ElemGroup> elemGroups;         // 活动请求的项目组
        private int elemGroupCnt;                   // 活动项目组的数量
        ...
        private void InitModbusPoll()
        {
            ...
            {
                // find the required size of the input buffer   //请求数据长度
                int inBufSize = 0;
        ...
        /// <summary>
        /// Выполнить сеанс опроса КП //Session轮询
        /// </summary>
