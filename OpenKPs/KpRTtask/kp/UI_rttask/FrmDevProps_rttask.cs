...
namespace Scada.Comm.Devices.rttask.UI
{
    ...
    public partial class FrmDevProps : Form
    {
        ...
        {
            FrmDevTemplate_rttask.ShowDialog(appDirs, uiCustomization, true, ref fileName);
        ...
        {
            // перевод формы
            Translator.TranslateForm(this, "Scada.Comm.Devices.rttask.UI.FrmDevProps", toolTip);
