...
namespace Scada.Comm.Devices.rttask.UI
{
    ...
    {
        // Scada.Comm.Devices.rttask.UI.FrmDevTemplate
        ...
        // Scada.Comm.Devices.rttask.UI.FrmDevProps
        public static string TemplNotExists { get; private set; }

        public static void Init()
        {
            Localization.Dict dict = Localization.GetDictionary("Scada.Comm.Devices.rttask.UI.FrmDevTemplate");
            ...
            dict = Localization.GetDictionary("Scada.Comm.Devices.rttask.UI.FrmDevProps");
