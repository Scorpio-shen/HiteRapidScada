...
namespace Scada.Web.Plugins.Chart
{
    ...
    public class ChartDataBuilder
    {
        ...
        {
            LogHelpter.AddLog("JJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJjj");
        ...
        {
            LogHelpter.AddLog("mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm");
        ...
        protected void FillTrendBundle()
        {
            ...
            {
                LogHelperNet.WriteLog("FillTrendBundle " + i.ToString()+"--------");
        ...
        protected string GetTrendPointsJs(TrendBundle trendBundle, int trendInd)
        {
            ...
            LogHelpterAnDa.AddLog("GetTrendPointsJs          ");
        ...
        {
            LogHelpter.AddLog("nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn");
            if (cnlCnt <= 1)
                FillSingleTrend();
            else
                FillTrendBundle();
        ...
        public void ToJs(StringBuilder stringBuilder)
        {
            ...
            LogHelpter.AddLog("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT");
            LogHelperNet.WriteLog("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBNNNNNNNNNNNNN");
