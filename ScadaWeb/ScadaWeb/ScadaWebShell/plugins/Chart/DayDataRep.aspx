<%@ Page Title="Day Data Report" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="DayDataRep.aspx.cs" Inherits="Scada.Web.Plugins.Chart.DayDataRep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Day" runat="server" Text="Day Data Report"></asp:Label></h1>
