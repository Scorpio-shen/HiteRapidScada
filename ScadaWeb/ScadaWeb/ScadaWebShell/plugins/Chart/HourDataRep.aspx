<%@ Page Title="Hour Data Report" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="HourDataRep.aspx.cs" Inherits="Scada.Web.Plugins.Chart.HourDataRep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Hour" runat="server" Text="Hour Data Report"></asp:Label></h1>
