<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="DatabaseConfig6.aspx.cs" Inherits="Scada.Web.plugins.Config.DatabaseConfig6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="数据库节点[5]配置表(预留页面)"></asp:Label></h1>
    </asp:Content>