<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="_4GConfig.aspx.cs" Inherits="Scada.Web.plugins.Config._4GConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="4G通讯模块配置(预留页面)"></asp:Label></h1>
    </asp:Content>