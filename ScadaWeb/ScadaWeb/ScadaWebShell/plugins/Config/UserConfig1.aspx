<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="UserConfig1.aspx.cs" Inherits="Scada.Web.plugins.Config.UserConfig1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_User" runat="server" Text="用户参数管理(预留页面)"></asp:Label></h1>
    </asp:Content>