<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="WebConfig2.aspx.cs" Inherits="Scada.Web.plugins.Config.WebConfig2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Web_2" runat="server" Text="Web Service配置(预留页面)"></asp:Label></h1>
    </asp:Content>