<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="Report_ParameterConfig.aspx.cs" Inherits="Scada.Web.plugins.Config.Report_ParameterConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="报表及变量模块配置(预留页面)"></asp:Label></h1>
    </asp:Content>