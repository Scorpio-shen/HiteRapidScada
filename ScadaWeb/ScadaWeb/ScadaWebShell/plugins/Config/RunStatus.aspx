<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="RunStatus.aspx.cs" Inherits="Scada.Web.plugins.Config.RunStatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="运行状态(预留页面)"></asp:Label></h1>
    </asp:Content>