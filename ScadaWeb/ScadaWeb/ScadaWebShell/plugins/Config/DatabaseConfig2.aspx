<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="DatabaseConfig2.aspx.cs" Inherits="Scada.Web.plugins.Config.DatabaseConfig2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="数据库节点[1]配置表(预留页面)"></asp:Label></h1>
    </asp:Content>