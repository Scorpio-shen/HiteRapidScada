<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="IP_MACConfig.aspx.cs" Inherits="Scada.Web.plugins.Config.IP_MACConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Database" runat="server" Text="IP与MAC参数配置(预留页面)"></asp:Label></h1>
    </asp:Content>