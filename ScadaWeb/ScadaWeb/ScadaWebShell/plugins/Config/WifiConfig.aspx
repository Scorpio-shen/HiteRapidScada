<%@ Page Title="Web Application Configuration" Language="C#" MasterPageFile="~/MasterMain.Master" AutoEventWireup="true" CodeBehind="WifiConfig.aspx.cs" Inherits="Scada.Web.plugins.Config.WifiConfig" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" runat="server">
    ...
    <h1><asp:Label ID="lblTitle_Web_3" runat="server" Text="Wifi模块配置(预留页面)"></asp:Label></h1>
    </asp:Content>