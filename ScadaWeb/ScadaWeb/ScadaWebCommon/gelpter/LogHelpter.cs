...
namespace Bit.Core.Web.Helpter
{
    class LogHelpter
    {
        /// <summary>
    ...
    class LogHelpterAnDa
    {
        ...
        {
            string fileName = fileFolderPath + "\\" + "log_cur.txt";
            string fileNameBackup = fileFolderPath + "\\" + "log_bak.txt";
        ...
        public static void GetLogUpload()
        {
            ...
            try
            {
                ...
                string fileName = fileFolderPath + "\\" + "log_cur.txt";
                string fileNameBackup = fileFolderPath + "\\" + "log_bak.txt";
                string fileNameUpload = fileFolderPath + "\\" + "log_upload.txt";
        ...
        public static void AddLog(string msg)
        {
            ...
            try
            {
                ...
                if (files.Length == 0)
                {
                    fileName = fileFolderPath + "\\" + "log_cur.txt";
                    goto DO_WRITE;
                }
                string[] files2 = files.OrderByDescending(x => x).ToArray();
                FileInfo fileInfo = new FileInfo(files2[0]);
